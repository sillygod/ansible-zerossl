...
class TestSplitWorkflow:
    ...
    def test_step1_certificate_request(
        self,
        mock_action_base,
        mock_task_vars,
        sample_api_key,
    ...
    def test_step2_validation_file_placement(
    ...
    def test_step3_certificate_validation(
        self,
        mock_action_base,
        mock_task_vars,
        sample_api_key,
    ...
    def test_step4_certificate_download(
        self,
        mock_action_base,
        mock_task_vars,
        sample_api_key,
    ...
    def test_complete_split_workflow_sequence(
        self,
        mock_action_base,
        mock_task_vars,
        sample_api_key,
    ...
    def test_split_workflow_error_handling(
        self,
        mock_action_base,
        mock_task_vars,
        sample_api_key,
    ...
    def test_split_workflow_validation_methods(
        self,
        mock_action_base,
        mock_task_vars,
        sample_api_key,
    ...
    def test_split_workflow_state_persistence(
        self, mock_action_base, mock_task_vars, sample_api_key, temp_directory, mock_http_boundary
    ):
    ...
    def test_split_workflow_missing_certificate_id(
        self, mock_action_base, mock_task_vars, sample_api_key, mock_http_boundary
    ):
